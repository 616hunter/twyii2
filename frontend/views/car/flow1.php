	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<?php foreach($models as $v): ?>
				<tr data-id="<?=$v['id']?>">
					<td class="col1"><a href=""><img src="http://admin.yii2shop.com<?=$v['logo']?>" alt="" /></a>  <strong><a href=""><?=$v['name']?></a></strong></td>
					...
					<td class="col5">￥<span><?=$v['shop_price']*$carts[$v['id']]?></span></td>
		...
		<div class="cart_btn w990 bc mt10">
			...
			<a href="/goods/index" class="checkout">结 算</a>
		</div>
	</div>
	<!-- 主体部分 end -->
