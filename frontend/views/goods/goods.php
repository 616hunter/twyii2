		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?='http://admin.yii2shop.com'.$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?='http://admin.yii2shop.com'.$goods->logo?>" alt=""  width="350" height="350"/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="/images/preview_l8.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m2.jpg',largeimage: 'images/preview_l2.jpg'}"><img src="/images/preview_l8.jpg"></a>
								</li>
								<?php foreach(\backend\models\GoodsGallery::find()->where(['goods_id'=>$goods->id])->all() as $v):?>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: 'images/preview_m3.jpg',largeimage: 'images/preview_l3.jpg'}">  
	    							<img src="http://admin.yii2shop.com.<?=$v->path?>."></a>
								</li>
								<?php endforeach;?>
<!--								<li>-->
<!--									<a href="javascript:void(0);" -->
...
<!--								</li>-->
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?= date('Ymd His',$goods->create_time)?></li>
					...
					<form action="<?=\yii\helpers\Url::to(['/car/add-car'])?>" method="get" class="choose">
						<ul>
							<li>
								<dl>
									<dt>购买数量：</dt>
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								...
								<li><span>商品编号：</span><?=$goods->sn?></li>
								<li><span>品牌：</span><?=\backend\models\Brand::findOne(['id'=>$goods->brand_id])->name?></li>
