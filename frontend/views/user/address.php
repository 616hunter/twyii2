	...
	<div class="main w1210 bc mt10">
		...
		<div class="content fl ml10">
			<div class="address_hd">
				<h3>收货地址薄</h3>
				<?php foreach(\app\models\ShopAddress::find()->where(['user_id'=>\yii::$app->user->id])->all() as $v): ?>
				<dl>
					<dt><?='收件人:'.$v->name.'&emsp;'.'收货地址'.$v->address?></dt>
					<dd>
						<?php echo\yii\bootstrap\Html::a('修改',['user/address-edit','id'=>$v->id])?>
						<?php echo\yii\bootstrap\Html::a('删除',['user/address-delete','id'=>$v->id])?>
						<?php echo\yii\bootstrap\Html::a('设为默认地址',['user/address-status','id'=>$v->id])?>
...
<!--								<input type="text" id="name" name="ShopAddress[username]" class="txt" />-->
							<?=$form->field($model,'name')->label(false)?>
							<li>

							</li>
								<label for=""><span>*</span>所在地区：</label>
								<select name="ShopAddress[province_id]" id="province">
									<option value="">请选择省份</option>
								</select>
								<select name="ShopAddress[city_id]" id="city">
									<option value="">请选择城市</option>

								</select>
								<select name="ShopAddress[area_id]" id="area">
...
<!--								<input type="text" id="address" name="ShopAddress[address]" class="txt address"  />-->
								<?=$form->field($model,'address')->label(false)?>
							</li>
							<li>
								<label for=""><span>*</span>手机号码：</label>
								<?=$form->field($model,'tel')->label(false)?>
							</li>
							<li>
								<label for="">&nbsp;</label>
								<?=$form->field($model,'status')->checkbox([0=>'不是默认',1=>'默认地址'])?>
							</li>
							<li>
								<label for="">&nbsp;</label>
